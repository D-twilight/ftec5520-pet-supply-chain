...
function AssignRoles() {
    ...
    return (
        <div>
            ...
            <div className="Raw">
                <p className="title">Raw Material Suppliers:</p>
                <form onSubmit={handlerSubmitRMS}>
                    <input className="input-1" type="text" onChange={handlerChangeAddressRMS} placeholder="Ethereum Address" required />
                    <input className="input-2" type="text" onChange={handlerChangeNameRMS} placeholder="Raw Material Supplier Name" required />
                    <input className="input-3" type="text" onChange={handlerChangePlaceRMS} placeholder="Based In" required />
                    <Button variant="contained" startIcon={<InputIcon />} color="success" className="register" onClick={handlerSubmitRMS}>Register</Button>
                </form>
            ...
            <div className="Man">
                ...
                <form onSubmit={handlerSubmitMAN}>
                    <input className="input-1" type="text" onChange={handlerChangeAddressMAN} placeholder="Ethereum Address" required />
                    <input className="input-2" type="text" onChange={handlerChangeNameMAN} placeholder="Manufacturer Name" required />
                    <input className="input-3" type="text" onChange={handlerChangePlaceMAN} placeholder="Based In" required />
                    <Button variant="contained" startIcon={<InputIcon />} color="success" className="register" onClick={handlerSubmitMAN}>Register</Button>
                </form>
                <table className="table table-sm">
                    <thead>
                        <tr>
            ...
            <div className="Dis">
                ...
                <form onSubmit={handlerSubmitDIS}>
                    <input className="input-1" type="text" onChange={handlerChangeAddressDIS} placeholder="Ethereum Address" required />
                    <input className="input-2" type="text" onChange={handlerChangeNameDIS} placeholder="Distributor Name" required />
                    <input className="input-3" type="text" onChange={handlerChangePlaceDIS} placeholder="Based In" required />
                    <Button variant="contained" startIcon={<InputIcon />} color="success" className="register" onClick={handlerSubmitDIS}>Register</Button>
                </form>
            ...
            <div className="Ret">
                ...
                <form onSubmit={handlerSubmitRET}>
                    <input className="input-1" type="text" onChange={handlerChangeAddressRET} placeholder="Ethereum Address" required />
                    <input className="input-2" type="text" onChange={handlerChangeNameRET} placeholder="Retailer Name" required />
                    <input className="input-3" type="text" onChange={handlerChangePlaceRET} placeholder="Based In" required />
                    <Button variant="contained" startIcon={<InputIcon />} color="success" className="register" onClick={handlerSubmitRET}>Register</Button>
                </form>
